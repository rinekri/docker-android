...
RUN apt-get update -yqq && \
    ...
    apt-get update -yqq && \
    apt-get install -y openjdk-23-jdk curl expect git git-lfs libc6:i386 libncurses5:i386 libstdc++6:i386 zlib1g:i386 wget unzip vim jq && \
    apt-get clean

RUN sudo update-java-alternatives --set java-1.23.0-openjdk-amd64
